...
fileID = fopen('D:\IC\BioMedical\Individual Project\Code\Centroid\Processed_Bubble\F_62\Pred_Label\CEUS62_label.txt','r');
formatSpec = '%d %d %d %d';
sizeA = [4,15];
...
%% 读取groundtruth
fileID_gt = fopen('D:\IC\BioMedical\Individual Project\Code\Centroid\Processed_Bubble\F_62\Groundtruth\Label62.txt','r');
...
cd('D:\IC\BioMedical\Individual Project\Code\Centroid\Processed_Bubble\F_62\Pred_Bubble');
Files=dir('CEUS*.*');
...
%With bbox
originalImage = imread('D:\IC\BioMedical\Individual Project\Code\Centroid\Processed_Bubble\F_62\Pred_bbox\CEUS62.jpg');
