...
fileID = fopen('D:\IC\BioMedical\Individual Project\Code\Centroid\Pred_Label\CEUS92_label.txt','r');
formatSpec = '%d %d %d %d';
sizeA = [4,15];
...
%% 读取groundtruth
fileID_gt = fopen('D:\IC\BioMedical\Individual Project\Code\Centroid\Groundtruth\Label92_gt.txt','r');
...
for k = 1:length(Files)
 FileNames = sprintf('CEUS92.jpg_Bubble_%d.jpg', k-1);
...
%With bbox
originalImage = imread('D:\IC\BioMedical\Individual Project\Code\Centroid\\Pred_bbox\CEUS92.jpg');
